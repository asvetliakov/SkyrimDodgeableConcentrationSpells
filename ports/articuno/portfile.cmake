...
file(READ "${SOURCE_PATH}/include/articuno/archives/ryml/yaml_source.h" FILE_CONTENT)
string(REPLACE "::std::format" "::fmt::format" FILE_CONTENT "${FILE_CONTENT}" )
file(WRITE "${SOURCE_PATH}/include/articuno/archives/ryml/yaml_source.h" "${FILE_CONTENT}")
